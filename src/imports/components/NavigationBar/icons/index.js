  ...
  render() {
    return (
      <svg width="35px" height="26px" viewBox="0 0 35 26">
        <path fill="#000000" d="M8,0 L35,0 L35,2 L8,2 L8,0 Z M0,12 L35,12 L35,14 L0,14 L0,12 Z M8,24 L35,24 L35,26 L8,26 L8,24 Z" />
      </svg>
    );
  }
}
