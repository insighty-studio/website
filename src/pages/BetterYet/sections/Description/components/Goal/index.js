...
BetterYet
          ...
          {' '}
mission is to equip small and medium-sized businesses with the
          means to make travel expenses part of a frictionless and simple experience.
        </div>
        <div>
          <br />
The team from BetterYet approached us with the challenge to create an easy-to-use product
        ...
        <div>
          <br />
Working in close collaboration with BetterYet’s product and business team we were able to shift the
